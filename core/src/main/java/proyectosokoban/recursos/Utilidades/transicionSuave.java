...
public class transicionSuave {
    ...
    public static void fadeOutAndChangeScreen(final Main main, final Stage currentStage, final Screen newScreen) {
        if (main.getBackgroundScreen() instanceof PantallaDeCarga) {
            ((PantallaDeCarga) main.getBackgroundScreen()).startTransitionAnimation();
        }
        ...
        currentStage.getRoot().addAction(Actions.sequence(
            ...
            Actions.run(new Runnable() {
                ...
                public void run() {
                    ...
                    if (main.getBackgroundScreen() instanceof PantallaDeCarga) {
                        ((PantallaDeCarga) main.getBackgroundScreen()).stopTransitionAnimation();
                    }
